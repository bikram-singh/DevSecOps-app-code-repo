pipeline {
    ...
    stages {
        ...
        stage('Git Checkout') {
            steps {
                git branch: 'main', credentialsId: 'github-token', url: 'https://github.com/bikram-singh/DevSecOps-app-code-repo.git'
            }
        }
        ...
        stage('Checkout K8s YAML Repo') {
            steps {
                git branch: 'main', credentialsId: 'github-token', url: 'https://github.com/bikram-singh/DevSecOps-helm-chart-repo.git'
            }
        }
